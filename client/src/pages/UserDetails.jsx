    ...
    <div className='bg-[#0B1215] text-[#FAF9F6] h-screen flex justify-center items-center'>
        <div className="detailsContainer md:max-w-[60%] p-4 md:p-0">
            ...
            <div className="form max-w-full bg-white mt-8">
                <input type="text" name="" id=""  placeholder='Your Name' className='w-full p-3 rounded-md text-[#0B1215] placeholder:text-[#0B1215] outline-none cursor-default font-Poppins md:text-md text-base' onChange={(e)=>{setNameofUser(e.target.value)}}/>
            </div>
